        ...
        <div className="modal__main">
          <header className="modal__header">
            ...
            <div className="modal__header__content">
              ...
              <p>Direct these funds where they are most needed.</p>
            </div>
          </header>
          <form action="">
            <div className="modal__body">
              <div className="modal__block donation--amount">
                <div className="form__group form--amount">
                  <label htmlFor="donation__amount">Enter Amount</label>
                  <input type="text" name="donation__amount" />
                  <span>$</span>
                  <small className="error--msg">Error</small>
                </div>

                <div className="donation__radio donation--frequency">
                  <ul>
                    <li>
                      <input type="radio" name="donation__frequency" />
...
export default ModalSelectDonation;

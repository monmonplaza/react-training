...
const ModalAddGenDonation = ({ item }) => {
  ...
  const { uploadPhoto, handleChangePhoto, photo } = useUploadPhoto(
    "/admin/gen-donation/upload-photo.php",
    dispatch
  );

  const initVal = {
    product: itemEdit ? itemEdit.gen_donation_id : "",
    product_name: itemEdit ? itemEdit.gen_donation_name : "",
    product_description: itemEdit ? itemEdit.gen_donation_description : "",
    product_amount: itemEdit ? itemEdit.gen_donation_amount : "",
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting, resetForm }) => {
                ...
                fetchData(
                  setLoading,
                  itemEdit
                    ? "/admin/gen-donation/update-gen-donation.php"
                    : "/admin/gen-donation/create-gen-donation.php",
                  {
                    ...values,
                    product_id: data.id,
                    product_photo: photo
...
export default ModalAddGenDonation;
